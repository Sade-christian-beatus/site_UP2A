...
export async function createCreneau(formData: FormData): Promise<ActionState> {
  ...
  revalidatePath("/admin/emplois-du-temps");
  revalidatePath("/etudiant/emploi-du-temps");
  return { success: true };
}
...
export async function createExamen(formData: FormData): Promise<ActionState> {
  ...
  revalidatePath("/etudiant/examens");
  return { success: true };
}
...
// ---------------------------------------------------------------------------
// Résultats — saisie groupée par examen (voir app/admin/resultats/[examenId]).
...
export async function upsertResultats(
  ...
  revalidatePath(`/admin/resultats/${examenId}`);
  revalidatePath("/etudiant/resultats");
  return { success: true };
}
...
export async function createSupport(formData: FormData): Promise<ActionState> {
  ...
  revalidatePath("/admin/supports-cours");
  revalidatePath("/etudiant/supports");
  return { success: true };
}
...
export async function createAnnonce(formData: FormData): Promise<ActionState> {
  ...
  revalidatePath("/etudiant/annonces");
  return { success: true };
}
