 ...
 * inc/formation-detail.php). Contenu strictement repris de
 * up2a_core_formations() : aucune information (programme détaillé,
...
$formation = up2a_core_find_formation( (string) get_query_var( 'up2a_formation' ) );
if ( null === $formation ) {
	// Filet de sécurité : ne devrait pas arriver (déjà vérifié dans
	// inc/formation-detail.php avant de servir ce template).
	get_header();
	echo '<main class="up2a-section-inner" style="padding:80px 24px;text-align:center;"><p>' . esc_html__( 'Formation introuvable.', 'up2a-core' ) . '</p></main>';
	get_footer();
	return;
}
...
<main id="up2a-formation-page" class="up2a-formation-page">
	...
	<nav class="up2a-formation-page__breadcrumb" aria-label="<?php esc_attr_e( 'Fil d\'Ariane', 'up2a-core' ); ?>">
		<div class="up2a-section-inner">
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e( 'Accueil', 'up2a-core' ); ?></a>
			<span aria-hidden="true">/</span>
			<a href="<?php echo esc_url( home_url( '/#up2a-formations' ) ); ?>"><?php esc_html_e( 'Formations', 'up2a-core' ); ?></a>
			<span aria-hidden="true">/</span>
	...
	<section class="up2a-formation-page__banner">
		<div class="up2a-section-inner up2a-formation-page__banner-grid">
			...
			<div class="up2a-formation-page__banner-text">
				...
				<p class="up2a-formation-modal__highlight"><?php echo up2a_core_content_icon( $formation['icone'] ); ?> <?php esc_html_e( 'Licence · 3 ans', 'up2a-core' ); ?></p>
	...
	<section class="up2a-formation-page__body">
		<div class="up2a-section-inner up2a-formation-page__body-grid">
			<div class="up2a-formation-page__main">
				<h2 class="up2a-section-title up2a-section-title--left"><?php esc_html_e( 'Présentation', 'up2a-core' ); ?></h2>
				<p class="up2a-formation-modal__intro"><?php echo esc_html( $formation['intro'] ); ?></p>

				<h2 class="up2a-section-title up2a-section-title--left"><?php esc_html_e( 'Débouchés', 'up2a-core' ); ?></h2>
				...
				<h2 class="up2a-section-title up2a-section-title--left"><?php esc_html_e( 'Programme', 'up2a-core' ); ?></h2>
				<p class="up2a-formation-page__placeholder">
					<?php echo up2a_core_content_icon( 'clock' ); ?>
					<?php esc_html_e( 'Le détail du programme (matières et volumes horaires) sera publié prochainement.', 'up2a-core' ); ?>
				</p>

				<h2 class="up2a-section-title up2a-section-title--left"><?php esc_html_e( "Conditions d'admission", 'up2a-core' ); ?></h2>
				<ol class="up2a-formation-page__steps">
					<li><?php esc_html_e( 'Remplissez le formulaire de préinscription en ligne.', 'up2a-core' ); ?></li>
					<li><?php esc_html_e( "Joignez vos pièces d'identité et diplômes.", 'up2a-core' ); ?></li>
					<li><?php esc_html_e( 'Recevez une confirmation par e-mail dès l\'enregistrement de votre dossier.', 'up2a-core' ); ?></li>
					<li><?php esc_html_e( "L'université étudie votre dossier et vous contacte pour la suite du processus.", 'up2a-core' ); ?></li>
				</ol>
				<p class="up2a-formation-page__note"><?php esc_html_e( 'Aucun frais à régler à cette étape.', 'up2a-core' ); ?></p>

				<a href="<?php echo esc_url( up2a_core_preinscription_url( $formation['slug'] ) ); ?>" class="up2a-hero__cta up2a-hero__cta--accent">
					<?php esc_html_e( 'Faire ma préinscription pour cette formation', 'up2a-core' ); ?>
					<?php echo up2a_core_content_icon( 'arrow' ); ?>
				</a>
			</div>

			<aside class="up2a-formation-page__aside">
				<h2 class="up2a-formation-page__aside-title"><?php esc_html_e( 'Autres formations', 'up2a-core' ); ?></h2>
